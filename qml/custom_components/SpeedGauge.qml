...
Item {
    ...
    property string dataMapLabel: label
    ...
    Text {
        ...
        id: textValue
        font: Qt.font({ family: valueFont.name, pixelSize: 150, weight: Font.Normal, capitalization: Font.AllUppercase })
...
//            fontSizeMode: Text.Fit
    ...
    Text {
        ...
        font: Qt.font({ family: valueFont.name, pixelSize: unitFontSize, weight: Font.Normal, italic: gaugeLabelItalic })
        color: "#00da75"
        property color bgColor: "#00000000"
        property color borderColor: "#4286f4"
        property int borderRadius: 0
