...
//    minimumValueAngle: (gauge.maximumValueAngle < gauge.minimumValueAngle ? gauge.maximumValueAngle : gauge.minimumValueAngle)  						// The start angle of the gauge markings top most is zero deg
//    maximumValueAngle: (gauge.maximumValueAngle < gauge.minimumValueAngle ? gauge.minimumValueAngle : gauge.maximumValueAngle)							// End angle of the gauge markings
        ...
        ctx.reset();
           ...
           //console.log("gaugeFaceColor=" + gaugeFaceColor);
            ...
            ctx.arc(xCenter, yCenter, radius,
                degToRad(valueToAngle(gauge.minimumValue) - 90),degToRad(valueToAngle(gauge.maximumValue) - 90 ), valueToAngle(gauge.maximumValue) < valueToAngle(gauge.minimumValue));
            ctx.stroke();
...
//        transform: Rotation {
//            angle: upsideDown ? -180 : 0
//            origin.x: gaugeCanvas.width / 2
//            origin.y: gaugeCanvas.height / 2
//        }
