...
Item {
	...
	Item {
		...
		HaltechBigDigitalGauge {
					...
					{
						GaugeConfig.initGauge(screen_05_01,"screen_05_01");
					}			
				}	
	}
	...
	Item {
		...
		HaltechBigDigitalGauge {
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_05_02,"screen_05_02");
					}			
				}	
	}
	...
	Item {
		...
		HaltechBigDigitalGauge {
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_05_03,"screen_05_03");
					}			
				}	
	}
	...
	Item {
		...
		HaltechBigDigitalGauge {
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_05_04,"screen_05_04");
					}			
				}	
	}
	...
	Item {
		...
		HaltechBigDigitalGauge {
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_05_05,"screen_05_05");
					}			
				}	
	}
	...
	Item {
		...
		HaltechBigDigitalGauge {
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_05_06,"screen_05_06");
					}			
				}	
	}
	...
	Item {
		...
		GaugeSweeper {
			...
			Component.onCompleted:
			{
				GaugeConfig.initGauge(screen_05_07,"screen_05_07");
			}
		}
	}
