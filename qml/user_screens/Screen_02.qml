...
Item {
    ...
    Rectangle {
		...
		HaltechNewCircularGauge {
			...
			dataMapValue : 1000 *(screen_02_heroCircularGauge.gaugeMinimumValue + (screen_02_heroCircularGauge.gaugeMaximumValue - screen_02_heroCircularGauge.gaugeMinimumValue) * topLevelItem.randVal1)
            needleImageWidth: 18
            needleImageHeight: 160
			Component.onCompleted:
			{
				GaugeConfig.initGauge(screen_02_heroCircularGauge,"screen_02_heroCircularGauge");
			}
           ...
           /*Start:screen_02_heroCircularGauge*/
           gaugeMaximumValue: 8
           gaugeMinimumValue: 0
          ...
          /*End:screen_02_heroCircularGauge*/
		...
		Item{
				...
				HaltechBigNumericGauge{
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_02_11,"screen_02_11");
					}			
				}
				HaltechBigNumericGauge {
					id: screen_02_10
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_02_10,"screen_02_10");
					}
				}
				HaltechBigNumericGauge{
					id: screen_02_09
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_02_09,"screen_02_09");
					}			
				}
		}
		Item {
		...
		HaltechNewBarGauge{
			...
			Component.onCompleted:
			{
				GaugeConfig.initGauge(screen_02_01,"screen_02_01");
			}
		}
		HaltechNewBarGauge{
			id: screen_02_02
			...
			Component.onCompleted:
			{
				GaugeConfig.initGauge(screen_02_02,"screen_02_02");
			}
		}
		HaltechNewBarGauge{
			id: screen_02_03
			...
			Component.onCompleted:
			{
				GaugeConfig.initGauge(screen_02_03,"screen_02_03");
			}
		}
		HaltechNewBarGauge{
			id: screen_02_04
			...
			Component.onCompleted:
			{
				GaugeConfig.initGauge(screen_02_04,"screen_02_04");
			}
		}
		}
		Item {
		...
		HaltechNewBarGauge{
			...
			Component.onCompleted:
			{
				GaugeConfig.initGauge(screen_02_05,"screen_02_05");
			}
		}							
		HaltechNewBarGauge{
			id: screen_02_06
			...
			Component.onCompleted:
			{
				GaugeConfig.initGauge(screen_02_06,"screen_02_06");
			}
		}							
		HaltechNewBarGauge{
			id: screen_02_07
			...
			Component.onCompleted:
			{
				GaugeConfig.initGauge(screen_02_07,"screen_02_07");
			}
		}
		HaltechNewBarGauge{
			id: screen_02_08
			...
			Component.onCompleted:
			{
				GaugeConfig.initGauge(screen_02_08,"screen_02_08");
			}
		}
	}		
  }
