...
Item {
	...
	Item {
		...
		transform: Rotation { id: rot1
					origin.x: screen_04_heroLeftGauge.height / 2
					origin.y: screen_04_heroLeftGauge.height / 2
		...
		HaltechNewCircularGauge {
			...
			//dataMapValue : 0
			dataMapValue : 1000 *(screen_04_heroLeftGauge.gaugeMinimumValue + (screen_04_heroLeftGauge.gaugeMaximumValue - screen_04_heroLeftGauge.gaugeMinimumValue) * topLevelItem.randVal1)
            needleImageWidth: 18
            needleImageHeight: 160
			Component.onCompleted:
			{
				GaugeConfig.initGauge(screen_04_heroLeftGauge,"screen_04_heroLeftGauge");
			}
	...
	Item {
		transform: Rotation { id: rot
					origin.x: screen_04_heroRightGauge.width / 2
					origin.y: screen_04_heroRightGauge.width / 2
					axis.x:0; axis.y:1; axis.z:0
					angle: -70 }
	...
	HaltechNewCircularGauge {
            ...
            //imageSource: "../../images/HeroScreenTacho.png"
			//dataMapValue : 0
			dataMapValue : 1000 *(screen_04_heroRightGauge.gaugeMinimumValue + (screen_04_heroRightGauge.gaugeMaximumValue - screen_04_heroRightGauge.gaugeMinimumValue) * topLevelItem.randVal1)
            needleImageWidth: 18
            needleImageHeight: 160
			Component.onCompleted:
			{
				GaugeConfig.initGauge(screen_04_heroRightGauge,"screen_04_heroRightGauge");
			}
            ...
            gaugeStepSize: 0.01
			gaugeRedThickness: 0.32
           /*Start:screen_04_heroRightGauge*/
	...
	Item {
		...
		HaltechBigNumericGauge {
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_04_05,"screen_04_05");
					}
				}	
	}	
	...
	Item {
		...
		HaltechBigNumericGauge {
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_04_06,"screen_04_06");
					}			
				}	
	}	
	...
	Item {
		...
		HaltechBigNumericGauge {
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_04_07,"screen_04_07");
					}			
				}	
	}	
	...
	Item {
		...
		HaltechBigNumericGauge {
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_04_08,"screen_04_08");
					}			
				}	
		}
		Item {
		...
		HaltechBigNumericGauge {
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_04_09,"screen_04_09");
					}			
				}	
		}
	}
	...
	Item {
		...
		HaltechBigNumericGauge {
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_04_01,"screen_04_01");
					}			
				}	
	}
	Item {
		...
		HaltechBigNumericGauge {
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_04_02,"screen_04_02");
					}			
				}	
	}
	Item {
		...
		HaltechBigNumericGauge {
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_04_03,"screen_04_03");
					}			
				}	
	}
	Item {
		...
		HaltechBigNumericGauge {
					...
					Component.onCompleted:
					{
						GaugeConfig.initGauge(screen_04_04,"screen_04_04");
					}			
				}	
	}
